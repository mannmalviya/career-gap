...
A web app that helps users close the gap between their current skills and a target job, then (later) hands off the boilerplate of applying to an AI agent.
